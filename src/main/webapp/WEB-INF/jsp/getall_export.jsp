        ...
        <div class="x_panel">
            ...
            <div class="row">
                <a href="${pageContext.request.contextPath}/staff/main" class="btn btn-info"
                   role="button">返回主页</a>
                <a href="${pageContext.request.contextPath }/export/toadd"
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <nav aria-label="Page navigation">
                        <ul class="pagination">
                            <li><a href="${pageContext.request.contextPath }/export/getall?pn=1">首页</a>
                            </li>
                            <c:if test="${pageInfo.hasPreviousPage }">
                                <li>
                                    <a href="${pageContext.request.contextPath }/export/getall?pn=${pageInfo.pageNum-1}"
                            ...
                            <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                                ...
                                <c:if test="${page_Num != pageInfo.pageNum }">
                                    <li>
                                        <a href="${pageContext.request.contextPath }/export/getall?pn=${page_Num }">${page_Num }</a>
                                    </li>
                                </c:if>
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath }/export/getall?pn=${pageInfo.pages}">末页</a>
                            </li>
                        </ul>
                    </nav>
                </div>
