    ...
    <form class="form-horizontal form-label-left" method="post" action="insert" onsubmit="return checkall()">
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="inid" name="inid" class="form-control input-small input-sm " value="${export.inid}"
                       type="text" onblur="checkinid()"><span id="demo1" style="color: red;"></span>
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="proid" name="proid" class="form-control input-small input-sm " value="${export.proid}"
                       type="text" onblur="checkproid()"><span id="demo3" style="color: red;"></span>
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="pname" name="pname" class="form-control col-md-7 col-xs-5" value="${export.pname}"
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="num" name="num" class="form-control col-md-7 col-xs-5" value="${export.num}" type="text"
                       onblur="checknum()"><span id="demo4" style="color: red;"></span>
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="retdate" name="retdate" class="form-control col-md-7 col-xs-5"
                       value="<fmt:formatDate pattern="yyyy-MM-dd" value="${export.retdate}"/>" type="date">
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="marks" name="marks" class="form-control col-md-7 col-xs-5" value="${export.marks}"
                       type="text">
            </div>
        </div>
        <a onclick="history.back(-1);" class=" text-left btn btn-default  " role="button">返回上页</a>
        <button type="submit" id="submit"
                class="btn btn-primary text-center  col-md-offset-4 col-lg-offset-4col-xl-offset-4">添加
        </button>
    </form>
...
<script>
    ...
    function checkinid() {
        ...
        if (num) {
            if (!isNaN(num)) {
                ...
                document.getElementById("demo1").innerHTML = "订单编号错误";
    ...
    function checkname() {
        ...
        if (name) {
            ...
            document.getElementById("demo2").innerHTML = "请输入订单商品名";
    ...
    function checknum() {
        ...
        if (num) {
            if (!isNaN(num)) {
                ...
                document.getElementById("demo4").innerHTML = "商品数量错误";
