...
<div class="right_col" role="main">
    <form class="form-horizontal form-label-left" novalidate>
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="price" class="form-control col-md-7 col-xs-5" value="${kcxx.product.price}" type="text"
                       readonly>
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="inprice" class="form-control col-md-7 col-xs-5" value="${kcxx.product.inprice}" type="text"
                       readonly>
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="prodate" class="form-control col-md-7 col-xs-5"
                       value="<fmt:formatDate pattern="yyyy-MM-dd" value="${kcxx.product.prodate}"/>" type="text"
                       readonly>
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="reledate" class="form-control col-md-7 col-xs-5"
                       value="<fmt:formatDate pattern="yyyy-MM-dd" value="${kcxx.product.reledate}"/>" type="text"
                       readonly>
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="supname" class="form-control col-md-7 col-xs-5" value="${kcxx.product.supname}" type="text"
                       readonly>
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="protype" class="form-control col-md-7 col-xs-5" value="${kcxx.product.protype}" type="text"
                       readonly>
            </div>
        </div>
        <div class="item form-group">
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="unit" class="form-control col-md-7 col-xs-5" value="${kcxx.product.unit}" type="text"
                       readonly>
            </div>
        </div>
        <div class="item form-group">
