    ...
    <form class="form-horizontal form-label-left" method="post" action="update" onsubmit="return checkall()">
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="staffid" name="staffid" class="form-control input-small input-sm " value="${staff.staffid}"
                       type="text">
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="staffname" name="staffname" class="form-control col-md-7 col-xs-5" value="${staff.staffname}"
                       type="text" onblur="checkname()"><span id="demo1" style="color: red;"></span>
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="card" name="card" class="form-control col-md-7 col-xs-5" value="${staff.card}" type="text"
                       onblur="checkcard()"><span id="demo2" style="color: red;"></span>
            </div>
        </div>
        <div class="item form-group">
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="tel" name="tel" class="form-control col-md-7 col-xs-5" value="${staff.tel}" type="text"
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="stafftype" name="stafftype" class="form-control col-md-7 col-xs-5" value="${staff.stafftype}"
                       type="text">
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="pwd" name="pwd" class="form-control col-md-7 col-xs-5" value="${staff.pwd}" type="password"
                       placeholder="请填写密码">
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="pwd2" name="pwd2" class="form-control col-md-7 col-xs-5" type="password"
                       placeholder="请再次填写密码" onkeyup="validate()"><span id="tishi"></span>
            </div>
        </div>

        <a onclick="history.back(-1);" class=" text-left btn btn-default  " role="button">返回上页</a>
        <button type="submit" id="button"
                class="btn btn-primary text-center  col-md-offset-4 col-lg-offset-4col-xl-offset-4">修改
        </button>
    </form>
