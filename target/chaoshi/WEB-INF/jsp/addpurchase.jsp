	...
	<form class="form-horizontal form-label-left" method="post" action="insert" onsubmit="return checkall()">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-5">
                          <input id="inid" name="inid" class="form-control input-small input-sm " value="${purchase.inid}" onblur="checkinid()" type="text" ><span id="demo1" style="color: red;"></span>
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-5">
                            <label for="proid"></label><input id="proid" name="proid" class="form-control input-small input-sm " value="${purchase.proid}" type="text" onblur="checkproid()"><span id="demo3" style="color: red;"></span>
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-5">
                          <input id="pname" name="pname" class="form-control col-md-7 col-xs-5" value="${purchase.pname}" onblur="checkname()" type="text" ><span id="demo2" style="color: red;"></span>
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-5">
                            <label for="num"></label><input id="num" name="num" class="form-control col-md-7 col-xs-5" value="${purchase.num}" type="text" onblur="checknum()"><span id="demo4" style="color: red;"></span>
                        </div>
                      </div>
                     <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-5">
                            <label for="indate"></label><input id="indate" name="indate" class="form-control col-md-7 col-xs-5" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${purchase.indate}"/>" type="date" >
                          </div>
                      </div>
                        <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-5">
                            <label for="marks"></label><input id="marks" name="marks" class="form-control col-md-7 col-xs-5" value="${purchase.marks}" type="text" >
                        </div>
                        </div>
