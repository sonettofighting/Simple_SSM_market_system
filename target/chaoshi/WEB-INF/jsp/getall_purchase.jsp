	                  ...
	                  <div class="x_content">
					        ...
					        <c:forEach items="${pageInfo.list}" var="purchase">
					        	<tr>
					                         ...
					                         <th>
												...
												<a href="${pageContext.request.contextPath }/staff/flatform/purchase/edit?inid=${purchase.inid}" class="btn btn-primary btn-xs">修改</a>
					                            <a onclick="del(${purchase.inid})"  class="btn btn-danger btn-xs" aria-label="Left Align" role="button">删除</a>
					                         </th>
					          	</tr>
					         </c:forEach>
	                    </table>
						...
						<div class="row">
							...
							<div class="col-md-6">
								...
								<ul class="pagination">
									<li><a href="${pageContext.request.contextPath }/staff/flatform/purchase/getall?pn=1">首页</a></li>
									<c:if test="${pageInfo.hasPreviousPage }">
										<li><a href="${pageContext.request.contextPath }/staff/flatform/purchase/getall?pn=${pageInfo.pageNum-1}"
									...
									<c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
										...
										<c:if test="${page_Num != pageInfo.pageNum }">
											<li><a href="${pageContext.request.contextPath }/staff/flatform/purchase/getall?pn=${page_Num }">${page_Num }</a></li>
										</c:if>
									...
									<li><a href="${pageContext.request.contextPath }/staff/flatform/purchase/getall?pn=${pageInfo.pages}">末页</a></li>
								</ul>
								</nav>
							</div>
						</div>
