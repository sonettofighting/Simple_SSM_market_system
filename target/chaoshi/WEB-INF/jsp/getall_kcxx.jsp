 ...
 --%>					                         </th>
						...
						<div class="row">
							...
							<div class="col-md-6">
								...
								<ul class="pagination">
									<li><a href="${pageContext.request.contextPath }/staff/flatform/kcxx/getall?pn=1">首页</a></li>
									<c:if test="${pageInfo.hasPreviousPage }">
										<li><a href="${pageContext.request.contextPath }/staff/flatform/kcxx/getall?pn=${pageInfo.pageNum-1}"
									...
									<c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
										...
										<c:if test="${page_Num != pageInfo.pageNum }">
											<li><a href="${pageContext.request.contextPath }/staff/flatform/kcxx/getall?pn=${page_Num }">${page_Num }</a></li>
										</c:if>
									...
									<li><a href="${pageContext.request.contextPath }/staff/flatform/kcxx/getall?pn=${pageInfo.pages}">末页</a></li>
								</ul>
								</nav>
							</div>
						</div>
