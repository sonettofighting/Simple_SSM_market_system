...
<div class="right_col" role="main">
    <form class="form-horizontal form-label-left" method="post" name="form" action="updatepro"
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="pname" name="pname" class="form-control col-md-7 col-xs-5" value="${product.pname}"
                       type="text" onblur="check()"><span id="demo1"></span>
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="price" name="price" class="form-control col-md-7 col-xs-5" value="${product.price}"
                       type="text" onblur="ischeckNum()"><span id="demo2"></span>
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="inprice" name="inprice" class="form-control col-md-7 col-xs-5" value="${product.inprice}"
                       type="text" onblur="ischeckinprice()"> <span id="demo3"></span>
            </div>
        </div>
        <div class="item form-group">
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="protype" name="protype" class="form-control col-md-7 col-xs-5" value="${product.protype}"
                       type="text">
            </div>
        </div>
<%--        <div class="item form-group">--%>
