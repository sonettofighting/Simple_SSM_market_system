    ...
    <form class="form-horizontal form-label-left" method="post" action="update" onsubmit="return checkall()">
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="cusid" name="cusid" class="form-control col-md-7 col-xs-5" value="${custom.cusid}"
                       readonly="readonly" type="text"><span id="demo1" style="color: red;"></span>
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="cusname" name="cusname" class="form-control col-md-7 col-xs-5" value="${custom.cusname}"
                       type="text" onblur="checkname()"><span id="demo2" style="color: red;"></span>
            </div>
        </div>
        <div class="item form-group">
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="person" name="person" class="form-control col-md-7 col-xs-5" value="${custom.person}"
                       type="text">
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="address" name="address" class="form-control col-md-7 col-xs-5" value="${custom.address}"
                       type="text">
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="emali" name="emali" class="form-control col-md-7 col-xs-5" value="${custom.emali}"
                       type="text" onblur="checkemail()"><span id="demo4" style="color: red;"></span>
            </div>
        </div>
